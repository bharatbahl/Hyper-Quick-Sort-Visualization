...
public class merge3 {
  ...
  public static void main(String[] args) {
    ...
    MyModel7 myArrayClass = new MyModel7();

    MyView7 panel = new MyView7(myArrayClass);
   ...
   static void performSorting( MyModel7 myArrayClass) {
...
class MyView7 extends JPanel {
  MyModel7 myModel;
  public MyView7(MyModel7 myArrayClass) {
...
SendArray7 obj2 = new SendArray7();
