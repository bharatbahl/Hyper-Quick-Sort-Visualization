...
import static javaapplication2.MyModel1.a;
...
public class main4 {
  ...
  public static void main(String[] args) {
    ...
    MyModel4 myArrayClass = new MyModel4();

    MyView4 panel = new MyView4(myArrayClass);
   ...
   static void performSorting( MyModel4 myArrayClass) {
...
class MyView4 extends JPanel {
  MyModel4 myModel;
  public MyView4(MyModel4 myArrayClass) {
...
class SendArray4{
    ...
    static int arr4[]= new int[size/4];
...
class MyModel4 {
  ...
  public MyModel4() {
    ...
    for (int i = 3*arraySize; i < 4*arraySize; i++) {
      myArray[i-3*arraySize] = Integer.parseInt(a[i]);
    }
  }
SendArray4 obj1 = new SendArray4();
